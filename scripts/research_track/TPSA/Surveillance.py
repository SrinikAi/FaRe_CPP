...
def main():
    ...
    steps = 10
    pgm_filename = '/Users/sriapple/research-documentation/maps/20230130_livetest_inside_withObstacles.pgm'
    yaml_filename = '/Users/sriapple/research-documentation/maps/20230130_livetest_inside_withObstacles.yaml'
    ...
    goals = explore.set_goals(starting_position, explored_value, unexplored_value, steps)
    for item in goals:
